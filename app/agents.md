...
- architect with a multi-tiered architecture
  - API provides RESTful endpoints for objects
  - Client Utility functions provide object-oriented access to the API
